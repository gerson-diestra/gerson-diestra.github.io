...
•  U. E. Essien y S. I. Ele, "Cuckoo Sandbox and Process Monitor (Procmon) Performance Evaluation in Large-Scale Malware Detection and Analysis," British Journal of Computer Science & Information Technology, vol. 7, no. 4, pp. 12–22, 2024. 
•  C. W. Xu, "Automatically Generating User-specific Recovery Procedures After Malware Infections," Tesis de Máster, Delft University of Technology, 2023. 
•  M. Rodríguez, G. Betarte, y D. Calegari, "A Process Mining-Based Approach for Attacker Profiling," 2021 IEEE Symposium on Security and Privacy (SP), 2021. 
•  J. W. Mikhail, J. C. Williams, y G. R. Roelke, "ProcmonML: Generating Evasion Resilient Host-Based Behavioral Analytics from Tree Ensembles," Computers & Security, vol. 95, pp. 101869, 2020. 
•  E. C. Thompson, "Continuous Monitoring," Springer, capítulo 5, 2020. 
